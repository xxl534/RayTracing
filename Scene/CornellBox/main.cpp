...
Hitable*  CornellSmokeScene()
{
	...
	list[i++] = new Quad(Vector3(0.f, -50.f, 0.f), Vector3(0.f, 1.f, 0.f), Vector3(0.f, 0.f, -1.f), 100.f, 100.f, white);
	list[i++] = new Quad(Vector3(0.f, 50.f, 0.f), Vector3(0.f, -1.f, 0.f), Vector3(0.f, 0.f, 1.f), 100.f, 100.f, white);
	list[i++] = new Quad(Vector3(0.f, 49.99f, 0.f), Vector3(0.f, -1.f, 0.f), Vector3(0.f, 0.f, 1.f), 40.f, 40.f, light);
	list[i++] = new Quad(Vector3(0.f, 0.f, 50.f), Vector3(0.f, 0.f, -1.f), Vector3(0.f, 1.f, 0.f), 100.f, 100.f, white);
	Hitable* box1 = new Translate(new RotateY(new Box(Vector3(32.f, 64.f, 32.f), white), 18), Vector3(-15, -18.f, 20.f));
	Hitable* box2 = new Translate(new RotateY(new Box(Vector3(32.f), white), -15), Vector3(15, -34.f, -20.f));
	list[i++] = new ConstantMedium(box2, 0.01f, new ConstantTexture(Vector3(1.0f, 1.0f, 1.0f)));
	list[i++] = new ConstantMedium(box1, 0.01f, new ConstantTexture(Vector3(0.0f, 0.0f, 0.0f)));
	return new HitableList(list, i);
}
...
int main()
{
	...
	Hitable* world = CornellSmokeScene();
